    ...
    <body>
        ...
        <form action="recebe_formulario.php" method="post">
            ...
            <fieldset>
                ...
                <input type="radio" name="interesse" id="" value="home"> Home<br>
                <input type="radio" name="interesse" id="" value="contato"> Contato <br>
            </fieldset>
            <hr>
            <button type="submit">Enviar</button>
        </form>
        <!-- http://localhost/PHP_Curso_Pasta/avancando_php/form_validacao.php -->
    </body>
</html>